...
st.write("Plan your day trip itineary by entering your city and intrest")

with st.form("Planner Form"):
    city = st.text_input("Enter the city name for your trip")
    interests = st.text_input("Enter your interest (Comma-Seprated)")
    ...
    if submitted:
        if city and interests:
            ...
            st.warning("Please Fill both city and Interests ")